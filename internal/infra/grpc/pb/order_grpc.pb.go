...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*Orders, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*Orders, error) {
	out := new(Orders)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*Orders, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*Orders, error) {
