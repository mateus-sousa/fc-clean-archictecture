...
type OrderServiceClient interface {
	...
	GetAll(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*Orders, error)
}
...
func (c *orderServiceClient) GetAll(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*Orders, error) {
	out := new(Orders)
	err := c.cc.Invoke(ctx, "/pb.OrderService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	GetAll(context.Context, *Blank) (*Orders, error)
...
func (UnimplementedOrderServiceServer) GetAll(context.Context, *Blank) (*Orders, error) {
...
func _OrderService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.OrderService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetAll(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
